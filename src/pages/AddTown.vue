    ...
    methods: {
        ...
        async saveTown() {
            ...
            if(this.name == null){
                ...
                this.loading = true;
                try {
                    const response =  await axios.put(`${this.endpoint}add-town/${this.$route.params.id}`, {
                            name: this.name, 
            ...
            <div class="relative w-full max-w-2xl max-h-full">
              ...
              <div class="relative bg-white rounded-lg shadow">
                  ...
                  <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b">
                      <button type="button" @click="saveTown()" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                        <span v-if="loading">
